  ...
  return (
    <div className="w-full mt-3 m-auto rounded-lg shadow-lg grid grid-cols-1">
      {editorUsers?.map((editors, i) => (
          <tbody key={i} className="p-2 flex flex-row rounded-lg m-1 bg-slate-200 hover:bg-slate-300">
            <tr>
              <th>
                <img
              ...
              <td className="w-[300px]">
                <h3 className="p-2 m-auto text-center btn h-[60px] text-black font-bold w-1/2">{editors.role}</h3>
              </td>
              <td className="w-30">
