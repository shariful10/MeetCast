  ...
  return (
    <div className="">
      <div className="bg-slate-300 p-6 rounded-lg shadow-lg hover:bg-slate-400">
        ...
        <div className="w-full bg-slate-300 mt-2 rounded-lg shadow-lg p-3 grid grid-cols-3">
          <UserNumberCard></UserNumberCard>
          <Totalincome></Totalincome>
          <TotalLogIn></TotalLogIn>
          <div className="h-[300px] mt-3 mx-3 m-auto rounded-lg shadow-lg  bg-slate-200 p-3" style={{ gridColumn: '1 / 4'}}>
            <ChartInfo></ChartInfo>
          </div>
        </div>
      </div>
