        ...
        <div>
          ...
          <div className="contact-section bg-indigo-100 md:py-12 md:flex justify-between items-center">
            <div className="md:mx-8 mx-4">
              ...
              <form ref={form} onSubmit={sendEmail}>
                <div className="md:flex justify-between w-full">
                  ...
                  <br />
                  <input
                    className="my-2 md:mx-3 p-2 w-full"
                    type="text"
                ...
                <input
                  onClick={notify}
                  className="w-full my-2 p-2 bg-black text-white"
                  type="submit"
                  value="Send"
                />
                <Toaster />
            ...
            <div className="contact-details md:mx-8 py-4">
              <h4 className="flex items-center md:text-3xl font-bold">
                <FaPhoneAlt className="bg-indigo-500 text-white w-12 h-12 rounded-full mr-4 p-3"></FaPhoneAlt>{" "}
                +88 01518-726852
              </h4>
              <p className="ml-16">Free support</p>
              <h4 className="flex items-center md:text-3xl font-bold">
                <MdOutlineEmail className="bg-indigo-500 text-white w-12 h-12 rounded-full mr-4 p-3"></MdOutlineEmail>
