...
import { LuCalendarRange, LuMail, LuMegaphone, LuThumbsUp } from "react-icons/lu";
		...
		<div>
					...
					<div className="z-20">
						<div data-aos="fade-down" data-aos-duration="1500">
							...
							<p className="md:text-center lg:w-1/2 mx-auto text-[#1D2130] ">
								{" "}
								Make meaningful connections with meetings, team chat, whiteboard,
								phone, and more in one offering.
							</p>
						</div>
						<div
							data-aos="fade-right"
			...
			>
				...
				<p className="text-gray-400 lg:w-1/2 mx-auto">
					...
					attachments, or other communications like customer content such as poll results,
					whiteboard, and reactions to train Meetcast's or third-party artificial
					intelligence models.
				</p>
			</div>
				...
				<Container>
					<div className="flex flex-col md:flex-row justify-between">
						<div
							...
							className="text-left w-full lg:w-[640px] space-y-3"
						>
							<span className="md:text-2xl font-bold bg-gradient-to-r from-[#373FFF] to-[#3ACAF8] text-transparent bg-clip-text">
								Out Goals
							</span>
						...
						<div
							...
							data-aos-duration="1000"
							className="text-left w-full lg:w-[640px] mt-8 md:mt-0 space-y-3"
						>
							<span className="md:text-2xl font-bold bg-gradient-to-r from-[#373FFF] to-[#3ACAF8] text-transparent bg-clip-text">
								Out Goals
							</span>
				...
				<div>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-16 py-8 md:py-20 px-6 md:px-10  bg-[#F9F0FB]">
						<div data-aos="flip-down" data-aos-duration="1000">
							...
							<h2 className="text-2xl my-2 font-manrope font-bold">Best in Class</h2>
						...
						<div data-aos="flip-down" data-aos-duration="1000">
							...
							<h2 className="text-2xl my-2 font-manrope font-bold">Authenticity</h2>
							<p className="text-gray-400 mt-2">
								Authenticity is our core value. We foster genuine connections and
						...
						<div data-aos="flip-down" data-aos-duration="1000">
							...
							<h2 className="text-2xl my-2 font-manrope font-bold">Email Support</h2>
							<p className="text-gray-400 mt-2">
						...
						<div data-aos="flip-down" data-aos-duration="1000">
							...
							<p className="text-gray-400 mt-2">
								Don't miss out! Explore our current offers and save on your favorite
								products/services today.
							</p>
						</div>
						<div data-aos="flip-down" data-aos-duration="1000">
							<span className="text-4xl text-[#6B7CFF]">
