        ...
        <div className="grid lg:grid-cols-2 justify-between gap-10">
          <div className="order-last md:order-first">
            ...
            <p className="text-gray-400 my-10">
              Elevate your conversations with our face-to-face video
              conferencing. Experience lifelike interactions, seamless sharing,
              and secure connections, all from wherever you are. Join us and
              redefine your video conferencing experience today.
            </p>
