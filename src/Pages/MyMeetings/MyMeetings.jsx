                            ...
                            <tr key={meeting._id}>
                                ...
                                <td className="border px-4 py-2">
                                    ...
                                    >
                                        ...
                                        <span className="absolute top-0 left-0 bg-blue-800 text-white text-xs px-2 py-1 opacity-0 group-hover:opacity-100 transform translate-x-full transition duration-300 ease-in-out">Link Copied</span>
                                    </button>
                                </td>
                                <td className="border px-4 py-2">
                                    <button
